        ...
        <div>
            <section class="py-10 bg-gray-100 sm:py-16 lg:py-24">
                <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    ...
                    <img
                            className='p-2 text-center mx-auto p-5 align-middle justify-center'
                        ...
                        <p class="max-w-xl mx-auto mt-4 text-base leading-relaxed text-gray-500">We couldn’t start the list without talking about our Contact Us page. As we’ll note in other Contact Us pages, we begin with an engaging heading, “Have questions? Shoot us an Email.”</p>
                    </div>
